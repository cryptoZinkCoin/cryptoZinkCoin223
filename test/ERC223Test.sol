...
contract ERC223Test {
  ...
  string tokenName = "ZNK Token";
  string tokenSymbol = "ZNK";
  ...
  function testUnlockToken() {
    ...
    Assert.equal(token.balanceOf(address(this)), expected, "Owner should have 10000000000000000000 ZNK Token before transfer");
